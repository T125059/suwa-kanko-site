...
const allSpots = [
  ...
  { name: '霧ヶ峰高原', img: 'img/kirigamine.jpg', desc: '夏にはニッコウキスゲが咲き誇る広大な高原です。', category: 'nature', url: 'https://kirigamine.suwakanko.jp' },
  { name: '車山高原', img: 'img/kurumayama.jpg', desc: 'リフトで山頂まで行ける、360度のパノラマが魅力の高原です。', category: 'nature', url: 'https://kurumayama.com/tourism/' },
  { name: '諏訪大社 上社本宮', img: 'img/suwa-taisha.jpg', desc: '全国の諏訪神社の総本社。荘厳な雰囲気の歴史ある神社です。', category: 'history', url: 'https://suwataisha.or.jp' },
